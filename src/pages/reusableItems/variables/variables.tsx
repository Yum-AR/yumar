...
export const navigationSidebar = [
  { name: `Dashboard`, href: `/ownerdashboard`, icon: BeakerIcon, current: true },
  /* {
    name: 'Restaurants', href: '/ownerRestaurants', icon: CalendarIcon, current: false
  },
  { name: 'Internal Statistics', href: '#', icon: UserGroupIcon, current: false }*/
];
